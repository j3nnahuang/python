...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor, eliminationVariable):
        ...
        unconditioned_variables.discard(eliminationVariable)
        new_factor = Factor(unconditioned_variables, factor.conditionedVariables(), factor.variableDomainsDict())

        for assignment in new_factor.getAllPossibleAssignmentDicts():
            p_sum = 0
            for value in new_factor.variableDomainsDict()[eliminationVariable]:
                assignment[eliminationVariable] = value
                p_sum += factor.getProbability(assignment)
            new_factor.setProbability(assignment, p_sum)
